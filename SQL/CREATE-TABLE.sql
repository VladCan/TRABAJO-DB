...
ALTER TABLE incapacidad_temporal ADD CONSTRAINT incapacidad_temporal_pk PRIMARY KEY ( id_incapacidad_temporal );
...
ALTER TABLE lactancia ADD CONSTRAINT lactancia_pk PRIMARY KEY ( id_lactancia );
...
ALTER TABLE maternidad ADD CONSTRAINT maternidad_pk PRIMARY KEY ( id_maternidad );
...
ALTER TABLE sepelio ADD CONSTRAINT sepelio_pk PRIMARY KEY ( id_sepelio );
